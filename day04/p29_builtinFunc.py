...
## all 현재 컬렉션 데이더의 조건, 값이 참인값만 있는지 확인
print(all([1, 2, 3, 4 < 2, 5]))

## chr() 아스키나 유니코드 값을 받아서 글자로 변경
print(chr(97))
print(chr(44032))
## ascii() 영문자, 문자를 아스키 숫자와 유니코드숫자로 변경
print(ascii('가'))
...
## ⭐️ enumerate() : 열거하다 뜻, 데이터 포함 인덱스를 같이 생성해주는 역할
